...
// OBJETOS
Preferences preferences;  // memoria no volátil
Ticker tickerBoton;       // temporizador para contar segundos
...
#define PANTALLA_2 3
#define ESPERAR_SW2 4
#define AUMENTAR_UMBRAL 5
#define DISMINUIR_UMBRAL 6
  ...
  void loop() {
    ...
    switch (estado) {
      case PANTALLA_1:
        ...
        char buf1[10];
        sprintf(buf1, "%.1f C", temperatura);
        u8g2.drawStr(50, 15, buf1);
        u8g2.drawStr(5, 35, "VU:");
        char buf2[10];
        sprintf(buf2, "%d C", umbral);
        u8g2.drawStr(50, 35, buf2);
        u8g2.sendBuffer();
      ...
      case ESPERAR_SW1:
        if (digitalRead(sw1) == HIGH) estado = PANTALLA_1;
        else if (segundosBoton >= 5) estado = PANTALLA_2;
        break;
      ...
      case PANTALLA_2:
        ...
        char buf3[10];
        sprintf(buf3, "%d C", umbral);
        u8g2.drawStr(50, 20, buf3);
        u8g2.sendBuffer();
      ...
      case DISMINUIR_UMBRAL:
        if (digitalRead(sw2) == HIGH) {
          ...
          preferences.end();
          Serial.println("Umbral guardado en memoria");  // solo guarda al volver a P1
        }
        break;
    }
  }
